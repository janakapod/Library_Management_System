 ...
 * @author Extreme
 */
public class Inventory_ViewAll_GUI extends javax.swing.JFrame {

    /**
     * Creates new form Inventory_ViewAll_GUI
     */
    public Inventory_ViewAll_GUI() {
        initComponents();
        setResizable(false);
    }
    ...
    private void initComponents() {
        ...
        viewtable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Inventory ID", "Name", "Type", "Ammount", "Added Date"
            }
        ) {
        ...
        jScrollPane1.setBounds(10, 120, 770, 280);
        ...
        jButton3.setBounds(620, 60, 100, 30);
        ...
        setBounds((screenSize.width-816)/2, (screenSize.height-552)/2, 816, 552);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inventory_ViewAll_GUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
