 ...
 */
public class Newspaper_Viewall extends javax.swing.JFrame {

  
    public Newspaper_Viewall() {
        initComponents();
         setResizable(false);
    }
    ...
    private void initComponents() {
        ...
        viewtable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Date", "Sinhala Newspaper", "English Newspaper", "Ammount", "Price"
            }
        ) {
        ...
        jScrollPane1.setBounds(10, 100, 770, 390);
        ...
        jButton1.setBounds(40, 60, 90, 30);
        ...
        jButton2.setBounds(220, 60, 90, 30);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            while (rs.next()) {
                ...
                v.add(rs.getString("English_Paper"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Newspaper_Viewall.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
